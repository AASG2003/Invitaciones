...
/*
    var docRef = db.collection("eventoPlantilla").doc(guiInvitado);
...
////////////// Leer Data y la invitación reacciona de acuerdo a //////////////

db.collection("eventoPlantilla").where("gui", "==", guiInvitado)
    .get()
    .then((querySnapshot) => {
